...
import (
	...
	appv1alpha1 "github.com/jcpowermac/ansible-jupyter-operator/pkg/apis/app/v1alpha1"
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	if err != nil && errors.IsNotFound(err) {
		...
		deploy := r.deploymentForAnsibleJupyter(instance)
...
func (r *ReconcileAppService) deploymentForAnsibleJupyter(cr *appv1alpha1.AppService) *appsv1.Deployment {
	...
	deploy := &appsv1.Deployment{
		...
		Spec: appsv1.DeploymentSpec{
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					Containers: []corev1.Container{{ //why two brackets here - I am making the assumption its entries in the array
						Image: "docker.io/benthomasson/ansible-jupyter-kernel:latest",
